...
Node
  ...
  Description
    ...
    Text
      ...
      variables and then one variable for each evaluated Hom generator.  (The
      strand generator of bidegree $(0,0)$ is the unit of $C$ and gets no
      variable of its own.)  So $p_0,p_1$ are the coordinates $x_0,x_1$ of $X$
